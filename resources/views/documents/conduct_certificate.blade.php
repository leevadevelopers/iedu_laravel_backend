...
<head>
    <meta charset="utf-8">
    <title>Atestado de Comportamento</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div>Atestado de Comportamento</div>
    </div>

    <div class="certificate-title">ATESTADO DE COMPORTAMENTO</div>

    <div class="content">
        <p>
            Atestamos que <strong>{{ $student->first_name }} {{ $student->middle_name ?? '' }} {{ $student->last_name }}</strong>,
        ...
        <p>
            O comportamento do(a) estudante durante o período letivo tem sido <strong>satisfatório</strong>.
        </p>
