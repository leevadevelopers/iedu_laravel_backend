...
class SmartFormValidator
{
    ...
    /**
     * Validate compliance against methodology
     */
    public function validateCompliance(array $formData, string $methodology): array
    {
        $checker = $this->getComplianceChecker($methodology);
        return $checker->validateCompliance($formData);
    }
